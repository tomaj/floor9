...
Stav: `nápad` -> `zbieram materiál` -> `draft` -> `odoslané`

| # | Téma | Súbor | Stav | Pozn. |
|---|------|-------|------|-------|
...
Striedaj "tvrdé" delivery príbehy (Armagedon, Greenportal, Cortex) s ľahšími reflexiami (Kde je AI rýchle/pomalé, Dopamín a AI, tričko). Aby to nebola len séria "čo sme postavili", ale aj "ako o tom premýšľame". To druhé sa lepšie preposiela hore.
